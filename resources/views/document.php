...
<body class="document-printable">
    ...
    <div class="document-action-topbar">
        ...
        <a class="main-action-bright primary" href="javascript:window.print();"> <i class="las la-download"></i> Imprimir (Ctrl+P)</a>
    </div>
        ...
        <div class="document-content">
            ...
            <div class="legal-notice">
                <p>Se entregarán los siguientes documentos para completar el proceso de solicitud al VetCamp 2025:
                    ...
                    3. Ensayo escrito (500 palabras) y digital (video; 2 minuto o menos) que indique cuál es su interés por participar en el VetCamp.
                    ...
                    Las solicitudes serán evaluadas solo si se entrega toda la documentación requerida. Cupo máximo para 14 estudiantes por sección. Los
                    documentos deberán entregarse en http://vetcamp.upra.edu/ o en el Laboratorio de TVET (Salón E-110) de la UPR de Arecibo de
                    lunes a viernes de 7:00 am a 3:30 pm. Para dudas o información adicional llame al 787-815-0000 extensión 3475 o escriba a
