                ...
                <div class="documents-grid">
                    <?php if ($documents['written_essay'] != null) { ?>
                        <div><a onclick="showModal('fileViewPopup-<?= $documents['written_essay']['name'] ?>"
                                class="main-action-bright no-deco-action" href="#"><i class="las la-file-alt"></i>Ensayo
                                Escrito</a></div>
                    <?php } ?>
                    ...
                    <?php if ($documents['authorization_letter'] != null) { ?>
                        <div><a onclick="showModal('fileViewPopup-<?= $documents['authorization_letter']['name'] ?>')"
                                class="main-action-bright no-deco-action" href="#"><i class="las la-file-alt"></i>Carta
                                de Autorización</a></div>
                    <?php } ?>

                    <?php if ($documents['transcript'] != null) { ?>
                        <div><a onclick="showModal('fileViewPopup-<?= $documents['transcript']['name'] ?>')"
                                class="main-action-bright no-deco-action" href="#"><i class="las la-file-alt"></i>Transcripción
                                de créditos</a></div>
                    <?php } ?>

                    <? if ($documents['written_application'] != null) { ?>
                        <div><a onclick="showModal('fileViewPopup-<?= $documents['written_application']['name'] ?>')"
                                class="main-action-bright no-deco-action" href="#"><i class="las la-file-alt"></i>Solicitud
                                Escrita</a></div>
                    <? } ?>

                    <? if ($documents['picture'] != null) { ?>
                        <div><a onclick="showModal('fileViewPopup-<?= $documents['picture']['name'] ?>')"
                                class="main-action-bright no-deco-action" href="#"><i class="las la-file-alt"></i>Foto
                                2x2</a></div>
                    <? } ?>

                    <? if ($documents['recommendation_letter'] != null) { ?>
                        <div><a onclick="showModal('fileViewPopup-<?= $documents['recommendation_letter']['name'] ?>')"
                                class="main-action-bright no-deco-action" href="#"><i class="las la-file-alt"></i>Carta
