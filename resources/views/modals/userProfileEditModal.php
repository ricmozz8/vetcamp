    ...
    <div class="modal-content">
        ...
        <form action="/profile/update" method="POST">
            ...
            <div class="modal-actions">
                ...
                <a class="main-action-bright quaternary" onclick="closeModal('userProfileEditModal')">Cancelar</a>
                <button type="submit" class="main-action-bright"> <i class="las la-save"></i> Guardar</button>
