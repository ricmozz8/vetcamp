    ...
    <div class="modal-content">
        ...
        <form action="settings/e/rejected" method="POST">
            ...
            <div class="form-group">
                <textarea name="content" id="content" class="message-textarea" placeholder="Escriba su mensaje aquí..." aria-label="Message input"><?= isset($messages['denied']['content']) ? $messages['denied']['content'] : '' ?></textarea>
            </div>

            <input name="id" type="hidden" value="<?= isset($messages['denied']['id']) ? $messages['denied']['id'] : '' ?>">
            <input type="hidden" name="category" value="denied">
